...
//  2017-11-07      - �޸ĳ�֧��XE10.2���޸�PCharΪPAnsiChar
...
begin
     ...
     if Length(FCommName) < 5 then
        ...
        FCommName := '\\.\' + FCommName;  //֧�ִ�COM10������       //2017.07.01  steedsky    20190119
...
begin
     ...
     if not SetupReadEvent( @overlappedRead,
                          //  @szInputBuffer, INPUTBUFFERSIZE,            //��ǰ���滻Ϊ��һ�� 20190119
